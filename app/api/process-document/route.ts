...
export async function POST(request: NextRequest) {
  try {
    ...
    try {
      // Get file data directly from PostgreSQL (already stored as Buffer/Bytes)
      const fileBuffer = document.fileData.buffer.slice(
        document.fileData.byteOffset,
        document.fileData.byteOffset + document.fileData.byteLength
      );
